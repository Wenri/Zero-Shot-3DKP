...
INVERSE_CLASS_MAPPING.update((v, k) for k, v in CLASS_MAPPING.items())
...
KEYPOINT_LABELS = {
    ...
    "airplane": {
        ...
        3: ("the end of the left wing of the airplane", True, True),
        4: ("wing root of the left wing of the airplane", True, False),
        5: ("the end of the right wing of the airplane", True, True),
